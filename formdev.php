...
//Actual page source strings need to have no line breaks, '"' replaced with '/"', and target of POST changed to './' (as opposed to './formdev.php' to use the above server, or the clock IP for the running clock server, for testing purposes)
?>
...
<li><label>Last sync</label>As of page load time: [sync state]</li>
